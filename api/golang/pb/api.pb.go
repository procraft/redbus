...
func (*ConsumeRequest_Connect_RepeatStrategy_EvenConfig) Descriptor() ([]byte, []int) {
	return file_api_api_proto_rawDescGZIP(), []int{2, 0, 0, 0}
}
...
func (*ConsumeRequest_Connect_RepeatStrategy_ProgressiveConfig) Descriptor() ([]byte, []int) {
	return file_api_api_proto_rawDescGZIP(), []int{2, 0, 0, 1}
}
...
const file_api_api_proto_rawDesc = "" +
	"\n" +
	"\rapi/api.proto\x12\x0fsergiusd.redbus\"\x98\x01\n" +
	...
	"\amessage\x18\x02 \x01(\tR\amessage\x1as\n" +
	"\aMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12&\n" +
	"\x0eidempotencyKey\x18\x03 \x01(\tR\x0eidempotencyKey\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\tR\ttimestamp2\xb3\x01\n" +
	"\rRedbusService\x12N\n" +
