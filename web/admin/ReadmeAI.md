...
(`finished_at IS NOT NULL`); активные и ожидающие следующей попытки повторы он не затрагивает.
...
ошибки триаж, поддерживает restart как всего topic/group, так и одного класса ошибки, а также удаление
